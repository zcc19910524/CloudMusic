...
const initState={
    AllLists:[
        {
            url:'http://p3.music.126.net/Xmp5IgZB8Zms76sgNwdTsg==/109951162868760982.jpg?param=140y140',
            introduce:'2017年二月最热新歌TOP50'
        },
        {
            url:'http://p3.music.126.net/cDzKKVB5dM_AjTm-UnIE7w==/19105114044243895.jpg?param=140y140',
            introduce:'#科普贴#蛋蛋的忧伤'
        },
        {
...
const AllLists=(state=initState,action)=>{
    return state
}
